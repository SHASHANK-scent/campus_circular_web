  ...
  <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
    ...
    {slot.recommendation ? (
      ...
      <div className="rounded-xl bg-slate-50 p-4 text-xs text-slate-500">
        <p>No exact match. Post a community request and let nearby students help.</p>
        {onPostRequest && (
          <button
            onClick={onPostRequest}
            className="mt-3 rounded-lg bg-emerald-600 px-3 py-2 text-[11px] font-bold text-white"
          >
