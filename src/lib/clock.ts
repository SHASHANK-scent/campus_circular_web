export const simulatedNow = (stateNow?: string): Date =>
  new Date(stateNow ?? '2025-03-15T10:00:00+05:30')
export const advanceClock = (current: string, hours: number): string =>
  new Date(new Date(current).getTime() + hours * 3600000).toISOString()
